...
test_that("rda file made when indicated", {
  ...
  # expect that both figures_tables dir and the recruitment_figure.rda file exist
  expect_true(dir.exists(fs::path(getwd(), "figures_tables")))
  expect_true(file.exists(fs::path(getwd(), "figures_tables", "recruitment_figure.rda")))
