...
5. **Render the table.**  
   ...
   - the static reference tables (`table_afsc_tier()` and `table_harvest_projection()`) are built directly with `flextable`
...
- **Static reference tables:** `table_afsc_tier()`, `table_harvest_projection()`
