...
This folder is composed of all the exported and utility functions used in {stockplotr}.
Each script depicts the specific function withi the file. The utility file functions include
